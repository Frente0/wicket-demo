...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = {timestamp: "E3OD", version: "4.4.0", revision: "98daef5", rnd: Math.floor(900 * Math.random()) + 100, _: {pending: []}, status: "unloaded", basePath: function () {
    ...
    CKEDITOR.event || (CKEDITOR.event = function () {
        ...
        return{define: function (b, d) {
            ...
            function i(a, o, s, q) {
                a = {name: b, sender: this, editor: a, data: o, listenerData: e, stop: s, cancel: q, removeListener: k};
    ...
    (function () {
        ...
        function u(a, b, d, g) {
            ...
            if (g.doFilter) {
                a:{
                    ...
                    h = g.skipRequired;
                    r = {valid: false, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: false, allClasses: false, allStyles: false, hadInvalidAttribute: false, hadInvalidClass: false, hadInvalidStyle: false};
                    var w, t;
                    if (!a && !j)a = null; else {
                        q(b);
                        if (m) {
                    ...
                    for (var f = g.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || g.name == "body", p, e = d.length; e > 0;) {
                        ...
                        if (f && (l.type == CKEDITOR.NODE_TEXT || l.type == CKEDITOR.NODE_ELEMENT && G.$inline[l.name])) {
                            ...
                            p =
                                null;
                            l.insertAfter(a);
                            g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (l.type == CKEDITOR.NODE_ELEMENT && !G[g.name][l.name]) && c.push({check: "el-up", el: l})
                        }
                    }
                    a.remove()
                }
        ...
        CKEDITOR.filter.prototype = {allow: function (b, c, d) {
            ...
            var g = this, f = [], e = this.editor && this.editor.config.protectedSource, j, m = false, p = {doFilter: !c, doTransform: true, doCallbacks: true, toHtml: b};
            a.forEach(function (a) {
                if (a.type == CKEDITOR.NODE_ELEMENT) {
    ...
    (function () {
        ...
        var z = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", m = CKEDITOR.dtd, j = ["caption", "colgroup", "col", "thead", "tfoot",
            "tbody"], l = CKEDITOR.tools.extend({}, m.$blockLimit, m.$block), v = {elements: {input: n, textarea: n}}, P = {attributeNames: [
            [/^on/, "data-cke-pa-on"],
            [/^data-cke-expando$/, ""]
        ]}, r = {elements: {embed: function (a) {
            var b = a.parent;
            if (b && b.name == "object") {
    ...
    (function () {
        ...
        var q = function () {
                ...
                for (var r =
                    ...
                    if (a(e)) {
                        ...
                        if (s && j in CKEDITOR.dtd.$list)t = t.concat(b(e, d)); else {
                            ...
                            v == -1 && !m && (v = h);
                            m || (o = h);
                            t.push({isElement: 1, isLineBreak: n, isBlock: e.isBlockBoundary(), hasBlockSibling: f, node: e, name: j, allowed: m});
                            f = n = 0
                        }
                    } else t.push({isElement: 0, node: e,
                        allowed: 1})
                }
            ...
            var l = CKEDITOR.dtd, h = {p: 1, div: 1,
                h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1}, k = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, r = CKEDITOR.tools.extend({}, l.$inline);
            delete r.br;
            return function (h, i, v) {
                ...
                if (!s.checkReadOnly()) {
                    ...
                    if (x = v) {
                        ...
                        v = i.editor.dataProcessor.toHtml(v, {context: null, fixForBody: false, dontFilter: i.dontFilter, filter: i.editor.activeFilter,
    ...
    (function () {
        ...
        var P = {address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1}, r =
    ...
    (function () {
        ...
        CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({$: function (a) {
            ...
            proto: {renderHtml: function (a) {
                ...
                c.keyDownFn = k;
                d = {id: h, name: this.name || this.command, label: this.label, title: this.title, cls: this.className || "", titleJs: d.gecko && !d.hc ? "" : (this.title || "").replace("'", ""), keydownFn: k, focusFn: l, clickFn: e};
                i.output(d, b);
                if (this.onRender)this.onRender();
                return c
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.createFakeElement = function (a, b, c, d) {
            var e = this.lang.fakeobjects, e = e[c] || e.unknown, b = {"class": b, "data-cke-realelement": encodeURIComponent(a.getOuterHtml()), "data-cke-real-node-type": a.type, alt: e,
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("link", {requires: "dialog,fakeobjects", onLoad: function () {
            ...
            c.addMenuItems && c.addMenuItems({anchor: {label: c.lang.link.anchor.menu, command: "anchor", group: "anchor", order: 1}, removeAnchor: {label: c.lang.link.anchor.remove, command: "removeAnchor", group: "anchor", order: 5}, link: {label: c.lang.link.menu, command: "link", group: "link", order: 1},
