...
!function (t) {
    ...
    e.defaults = {transition_delay: 300, refresh_speed: 50, display_text: "none", use_percentage: !0, percent_format: function (t) {
        ...
        if ("center" === r.display_text && !s && !i) {
            ...
            var g;
            f ? (g = a.css("height"), s.css({height: g, "line-height": g}), i.css({height: g, "line-height": g}), t(window).resize(function () {
                g = a.css("height"), s.css({height: g, "line-height": g}), i.css({height: g, "line-height": g})
            })) : (g = a.css("width"), i.css({width: g}), t(window).resize(function () {
        ...
        setTimeout(function () {
            ...
            var v = setInterval(function () {
                f ? (p = n.height(), g = a.height()) : (p = n.width(), g = a.width()), t = Math.round(100 * p / g), e = Math.round(p / g * (d - h)), t >= l && (t = l, e = o, c(), clearInterval(v)), "none" !== r.display_text && (_ = r.use_percentage ? r.percent_format(t) : r.amount_format(e, d), "fill" === r.display_text ? n.text(_) : "center" === r.display_text && (s.text(_), i.text(_))), n.attr("aria-valuenow", e), u(t)
            }, r.refresh_speed)
        }, r.transition_delay)
    };
    ...
    t.fn.progressbar = function (n) {
        return this.each(function () {
            var a = t(this), s = a.data("bs.progressbar"), i = "object" == typeof n && n;
