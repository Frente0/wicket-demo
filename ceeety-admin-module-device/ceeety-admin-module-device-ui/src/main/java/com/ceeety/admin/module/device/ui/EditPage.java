    ...
    public EditPage(PageParameters parameters) {
        ...
        Form<Device> form = new Form<Device>("deviceForm"){
            ...
            protected void onInitialize() {
                ...
                device = Application.get().getDeviceService().queryForId(parameters.get("id").toLong());
                ...
                dropDownChoice = new DropDownChoice<DeviceType>("deviceType.id", new Model<DeviceType>(), deviceTypes, deviceTypeRenderer);
                dropDownChoice.setDefaultModelObject(device.getDeviceType());
                formPanel.add(dropDownChoice);
            ...
            protected void onSubmit() {
                ...
                Application.get().getDeviceService().update(device);
